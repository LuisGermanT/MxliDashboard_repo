...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <dx:PanelContent ID="PanelContent3" runat="server">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ds_kaizens" Theme="Default" Width="1024px">
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="impacto" VisibleIndex="8" Caption="IMPACTO">
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn FieldName="categoria" VisibleIndex="9" Caption="CATEGORIA">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="fecha_alta" VisibleIndex="7" Caption="FECHA_ALTA">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="area" VisibleIndex="8" Caption="AREA">
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn FieldName="celda" VisibleIndex="9" Caption="CELDA">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                    <GroupSummary>
                    ...
                    <GroupSummary>
                        <dx:ASPxSummaryItem FieldName="estatus_kaizen" ShowInColumn="ESTATUS" SummaryType="Count" />
                    </GroupSummary>
                    <GroupSummary>
                        <dx:ASPxSummaryItem FieldName="impacto" ShowInColumn="IMPACTO" SummaryType="Count" />
                    </GroupSummary>
                    <GroupSummary>
                        <dx:ASPxSummaryItem FieldName="categoria" ShowInColumn="CATEGORIA" SummaryType="Count" />
                    </GroupSummary>
                    <Styles>
    ...
    <asp:SqlDataSource ID="ds_kaizens" runat="server" ConnectionString="Data Source=MX29W1009;Initial Catalog=DB_1033_Dashboard;Persist Security Info=True;User ID=OPEX_Users;Password=Gqb%Pjo7XZ"
        SelectCommand="SELECT [kaizenid], [eid_originador], [nombre_originador], [eid_lun], [nombre_lun], [material], [estado_actual], [estatus_kaizen], [impacto], [categoria], [fecha_alta], [area], [celda] FROM [tbl_kaizens] where area like @pArea and celda like @pCelda and estatus_kaizen like @pCausa order by id">
        <SelectParameters>
