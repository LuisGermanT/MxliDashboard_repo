...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <dx:PanelContent ID="PanelContent2" runat="server">
                <table style="table-layout: fixed">
                    <tr>                       
                        ...
                        <th>
                            <dx:ASPxLabel ID="ASPxLabelCaption4" runat="server" Text="Select AorB" Font-Names="Honeywell Sans Web" Font-Size="Medium">
                            </dx:ASPxLabel>
                            <dx:ASPxComboBox ID="ASPxComboBoxAorbInContent" runat="server" ValueField="aorb"
                                ...
                                AutoPostBack="True" OnDataBound="cmbox_DataBoundAorb" Theme="Office365">
                                <ClientSideEvents Validation="function(s, e) {
                                            if (s.GetSelectedIndex()==0) {
                                            e.isValid = false;
                                            e.errorText = &quot;You should Select One AorB&quot;;
                                            }}" />
                                <ValidationSettings ValidateOnLeave="False">
                                </ValidationSettings>
                            </dx:ASPxComboBox>
        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent4" runat="server">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ds_entitlement" Theme="Office2010Silver" Width="100%" EnableTheming="True">
                    ...
                    <SettingsExport EnableClientSideExportAPI="true" FileName="ENTITLEMENT" />
                    <Toolbars>
                        <dx:GridViewToolbar>
    ...
    <SelectParameters>
        ...
        <asp:ControlParameter ControlID="ASPxRoundPanel2$ASPxComboBoxCellInContent"
            ...
            <asp:ControlParameter ControlID="ASPxRoundPanel2$ASPxComboBoxAorbInContent"
            ...
            <dx:PanelContent ID="PanelContent5" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSourceActions" runat="server" ConnectionString="<%$ ConnectionStrings:DB_1033_DashboardConnectionString %>" 
                    ...
                    <InsertParameters>                        
                        ...
                        <asp:Parameter Name="report" Type="String" DefaultValue="ENTITLEMENT" />
                    </InsertParameters>
                    <SelectParameters>
                        <asp:Parameter DefaultValue="entitlement" Name="report" Type="String" />
                    </SelectParameters>
                    <UpdateParameters>                        
                        <asp:Parameter Name="issue" Type="String" />
                        <asp:Parameter Name="action" Type="String" />
