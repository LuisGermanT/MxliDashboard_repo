                ...
                <table style="table-layout: fixed">
                    <tr>                       
                        <th>
                            ...
                            <dx:ASPxComboBox ID="ASPxComboBoxVsmInContent" runat="server" ValueField="sarea"
                                TextField="sarea" ValueType="System.String" DataSourceID="SqlDataSourceVsm"
        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent4" runat="server">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ds_output" Theme="Default" Width="1024px">
                    ...
                    <SettingsExport EnableClientSideExportAPI="true" FileName="OUTPUT" />
                    <Toolbars>
                        <dx:GridViewToolbar>
        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent5" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSourceActions" runat="server" ConnectionString="<%$ ConnectionStrings:DB_1033_DashboardConnectionString %>" 
                    ...
                    <SelectParameters>
                        <asp:Parameter DefaultValue="output" Name="report" Type="String" />
                    </SelectParameters>
                    <UpdateParameters>                        
                        <asp:Parameter Name="issue" Type="String" />
                        <asp:Parameter Name="action" Type="String" />
