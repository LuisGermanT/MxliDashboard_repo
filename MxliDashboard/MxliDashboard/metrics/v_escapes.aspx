<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_escapes.aspx.cs" Inherits="MxliDashboard.v_escapes" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_escapes" DisableHttpHandlerValidation="False">
