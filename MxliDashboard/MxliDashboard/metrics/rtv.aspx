<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rtv.aspx.cs" Inherits="MxliDashboard.n3_Inventory.rtv" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent4" runat="server">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ds_inventory" Theme="Metropolis" Width="1100px" EnableTheming="True" OnCustomUnboundColumnData="grid_CustomUnboundColumnData">
                    ...
                    <SettingsExport EnableClientSideExportAPI="true" FileName="RTV" />
                    <Toolbars>
                        <dx:GridViewToolbar>
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="xWeek" VisibleIndex="9" Caption="WEEK">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                    <TotalSummary>
    ...
    <asp:SqlDataSource ID="ds_inventory" runat="server" ConnectionString="Data Source=MX29W1009;Initial Catalog=DB_1033_Dashboard;Persist Security Info=True;User ID=OPEX_Users;Password=Gqb%Pjo7XZ"
        SelectCommand="SELECT * FROM [sap_rtv] where smrp like @pMrp">
    <SelectParameters>
            ...
            <dx:PanelContent ID="PanelContent5" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSourceActions" runat="server" ConnectionString="<%$ ConnectionStrings:DB_1033_DashboardConnectionString %>" 
                    ...
                    <InsertParameters>                        
                        ...
                        <asp:Parameter Name="report" Type="String" DefaultValue="RTV" />
                    </InsertParameters>
                    <SelectParameters>
                        <asp:Parameter DefaultValue="rtv" Name="report" Type="String" />
                    </SelectParameters>
                    <UpdateParameters>                        
                        <asp:Parameter Name="issue" Type="String" />
                        <asp:Parameter Name="action" Type="String" />
