<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="pros.aspx.cs" Inherits="MxliDashboard.n3_Quality.pros" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent2" runat="server">
                <table style="table-layout: fixed">
                    <tr>                       
                        <th>
                            <dx:ASPxLabel ID="ASPxLabelCaption1" runat="server" Text="Select Classification" Font-Names="Honeywell Sans Web" Font-Size="Medium">
                            </dx:ASPxLabel>
                            <dx:ASPxComboBox ID="ASPxComboBoxClasInContent" runat="server" ValueField="ageClass"
                                TextField="ageClass" ValueType="System.String" DataSourceID="SqlDataSourceClas"
                                AutoPostBack="True" OnDataBound="cmbox_DataBoundClas" 
                                OnSelectedIndexChanged="ASPxComboBoxClasInContent_SelectedIndexChanged" Theme="Office365">
                                <ClientSideEvents Validation="function(s, e) {
                                            if (s.GetSelectedIndex()==0) {
                                            e.isValid = false;
                        ...
                        <th>
                            <dx:ASPxLabel ID="ASPxLabelCaption2" runat="server" Text="Select Cause" Font-Names="Honeywell Sans Web" Font-Size="Medium">
                            </dx:ASPxLabel>
                            <dx:ASPxComboBox ID="ASPxComboBoxCauseInContent" runat="server" ValueField="causa"
                                TextField="causa" ValueType="System.String" DataSourceID="SqlDataSourceCause"
                        ...
                        <th>
                            <dx:ASPxLabel ID="ASPxLabelCaption3" runat="server" Text="Select Status" Font-Names="Honeywell Sans Web" Font-Size="Medium">
                            </dx:ASPxLabel>
                            <dx:ASPxComboBox ID="ASPxComboBoxStaInContent" runat="server" ValueField="proStatus"
                                TextField="proStatus" ValueType="System.String" DataSourceID="SqlDataSourceSta"
        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent4" runat="server">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ds_pros" Theme="Default" Width="1024px">
                    ...
                    <SettingsExport EnableClientSideExportAPI="true" FileName="PROS" />
                    <Toolbars>
                        <dx:GridViewToolbar>
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="notification" VisibleIndex="1" Caption="QN">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="carId" VisibleIndex="2" Caption="CAR">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="causa" VisibleIndex="3" Caption="CAUSE">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="notifDate" VisibleIndex="4" Caption="NOTIF_Date">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="notifAge" VisibleIndex="5" Caption="NOTIF_Age">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="proAge" VisibleIndex="6" Caption="PRO_Age">
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn FieldName="ageClass" VisibleIndex="7" Caption="CLASSIFICATION">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="proStatus" VisibleIndex="8" Caption="STATUS">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="material" VisibleIndex="9" Caption="MATERIAL">
                        </dx:GridViewDataTextColumn>                       
                        <dx:GridViewDataTextColumn FieldName="serialNumber" VisibleIndex="10" Caption="SERIAL_NO">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="sWeek" VisibleIndex="11" Caption="WEEK">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                    <GroupSummary>
                        <dx:ASPxSummaryItem FieldName="id" ShowInColumn="causa" SummaryType="Count" />
                    </GroupSummary>
                    <GroupSummary>
                        <dx:ASPxSummaryItem FieldName="id" ShowInColumn="ageClass" SummaryType="Count" />
                    </GroupSummary>
                    <GroupSummary>
                        <dx:ASPxSummaryItem FieldName="id" ShowInColumn="material" SummaryType="Count" />
                    </GroupSummary>
                    <GroupSummary>
                        <dx:ASPxSummaryItem FieldName="id" ShowInColumn="sWeek" SummaryType="Count" />
                    </GroupSummary>
                    <GroupSummary>
                        <dx:ASPxSummaryItem FieldName="id" ShowInColumn="proStatus" SummaryType="Count" />
                    </GroupSummary>
                    <Styles>
    ...
    <asp:SqlDataSource ID="ds_pros" runat="server" ConnectionString="Data Source=MX29W1009;Initial Catalog=DB_1033_Dashboard;Persist Security Info=True;User ID=OPEX_Users;Password=Gqb%Pjo7XZ"
        SelectCommand="SELECT * FROM [tbl_pros] where ageClass like @pClass and causa like @pCausa and proStatus like @pProStatus  order by id">
        <SelectParameters>
            <asp:ControlParameter ControlID="ASPxRoundPanel2$ASPxComboBoxClasInContent"
                Name="pClass" PropertyName="Value" Type="String" />
            ...
            <asp:ControlParameter ControlID="ASPxRoundPanel2$ASPxComboBoxStaInContent"
                Name="pProStatus" PropertyName="Value" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSourceClas" runat="server" ConnectionString="Data Source=MX29W1009;Initial Catalog=DB_1033_Dashboard;Persist Security Info=True;User ID=OPEX_Users;Password=Gqb%Pjo7XZ"
        SelectCommand="SELECT distinct [ageClass] FROM [tbl_pros] order by ageClass"></asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSourceCause" runat="server" ConnectionString="Data Source=MX29W1009;Initial Catalog=DB_1033_Dashboard;Persist Security Info=True;User ID=OPEX_Users;Password=Gqb%Pjo7XZ"
        SelectCommand="SELECT distinct [causa] FROM [tbl_pros] order by causa"></asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSourceSta" runat="server" ConnectionString="Data Source=MX29W1009;Initial Catalog=DB_1033_Dashboard;Persist Security Info=True;User ID=OPEX_Users;Password=Gqb%Pjo7XZ"
        SelectCommand="SELECT distinct [proStatus] FROM [tbl_pros] order by proStatus"></asp:SqlDataSource>
    <p />
    <hr />
    <p />
            ...
            <dx:PanelContent ID="PanelContent5" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSourceActions" runat="server" ConnectionString="<%$ ConnectionStrings:DB_1033_DashboardConnectionString %>" 
                    ...
                    <InsertParameters>                        
                        ...
                        <asp:Parameter Name="report" Type="String" DefaultValue="PROS" />
                    </InsertParameters>
                    <SelectParameters>
                        <asp:Parameter DefaultValue="pros" Name="report" Type="String" />
                    </SelectParameters>
                    <UpdateParameters>                        
                        <asp:Parameter Name="issue" Type="String" />
                        <asp:Parameter Name="action" Type="String" />
