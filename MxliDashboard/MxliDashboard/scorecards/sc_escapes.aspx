<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="sc_escapes.aspx.cs" Inherits="MxliDashboard.sc_escapes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" runat="server" id="E01">
        <dx:ASPxRoundPanel ID="ASPxRoundPanel2" runat="server" Width="100%" HeaderText="Escapes filters" ForeColor="Black" AllowCollapsingByHeaderClick="True" BackColor="White">
            <HeaderStyle ForeColor="White" />
            <HeaderContent BackColor="#666666">
            </HeaderContent>
            <PanelCollection>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="text-align: center">
                                <dx:ASPxLabel ID="E01Report" runat="server" Text="Escapes" Font-Size="Medium" Font-Bold="True" ForeColor="#333333"></dx:ASPxLabel>
                            </td>
                            <td style="text-align: center">
                            ...
                            <td style="text-align: center">
                                <a class="btn btn-danger" href="../metrics/escapes.aspx">View &raquo;</a>
                            </td>
                            <td style="text-align: center">
                                <a class="btn btn-danger" href="../metrics/v_escapes.aspx">Open &raquo;</a>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
