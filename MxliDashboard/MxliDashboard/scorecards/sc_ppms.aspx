<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="sc_ppms.aspx.cs" Inherits="MxliDashboard.sc_ppms" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" runat="server" id="E01">
        <dx:ASPxRoundPanel ID="ASPxRoundPanel2" runat="server" Width="100%" HeaderText="PPMS filters" ForeColor="Black" AllowCollapsingByHeaderClick="True" BackColor="White">
            <HeaderStyle ForeColor="White" />
            <HeaderContent BackColor="#666666">
            </HeaderContent>
            <PanelCollection>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="text-align: center">
                                <dx:ASPxLabel ID="E01Report" runat="server" Text="PPMS" Font-Size="Medium" Font-Bold="True" ForeColor="#333333"></dx:ASPxLabel>
                            </td>
                            <td style="text-align: center">
                            ...
                            <td style="text-align: center">
                                <a class="btn btn-danger" href="../metrics/escapesppm.aspx">View &raquo;</a>
                            </td>
                            <td style="text-align: center">
                                <a class="btn btn-danger" href="../metrics/v_escapesppm.aspx">Open &raquo;</a>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
        ...
        <asp:SqlDataSource ID="SqlDataSourceVsm" runat="server" ConnectionString="Data Source=MX29W1009;Initial Catalog=DB_1033_Dashboard;Persist Security Info=True;User ID=OPEX_Users;Password=Gqb%Pjo7XZ"
            SelectCommand="SELECT distinct [sClass] FROM [sta_nivel2] where smetric in ('ppms') and sfilter = 'vsm' order by sClass"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSourceCell" runat="server" ConnectionString="Data Source=MX29W1009;Initial Catalog=DB_1033_Dashboard;Persist Security Info=True;User ID=OPEX_Users;Password=Gqb%Pjo7XZ"
            SelectCommand="SELECT distinct [sClass] FROM [sta_nivel2] where smetric in ('ppms') and sfilter = 'cell' order by sClass"></asp:SqlDataSource>
    </div>
</asp:Content>
