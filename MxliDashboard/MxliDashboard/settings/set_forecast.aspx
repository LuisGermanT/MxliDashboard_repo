...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" id="METRIC_GOALS" runat="server" visible="False">
        ...
        <div class="row" id="Div1" runat="server" visible="TRUE">
            <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceFore" EnableTheming="True" KeyFieldName="tbl_set_forecast_id" Theme="Mulberry" Width="100%">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="DESC" FieldName="gType" VisibleIndex="2" ReadOnly="true">
                    </dx:GridViewDataTextColumn>
            ...
            <asp:SqlDataSource ID="SqlDataSourceFore" runat="server" ConnectionString="<%$ ConnectionStrings:DB_1033_DashboardConnectionString %>"
                SelectCommand="SELECT [tbl_set_forecast_id], [metric], [gType], [gPreviousYear], [gM1], [gM2], [gM3], [gM4], [gM5], [gM6], [gM7], [gM8], [gM9], [gM10], [gM11], [gM12], [gActualYear] FROM [tbl_set_forecast] where [metric] = @param1 and gType = 'SITE'"
                UpdateCommand="UPDATE [tbl_set_forecast] SET [gPreviousYear] = @gPreviousYear, [gActualYear] = @gActualYear, [gM1] = @gM1, [gM2] = @gM2, [gM3] = @gM3, [gM4] = @gM4, [gM5] = @gM5, [gM6] = @gM6, [gM7] = @gM7, [gM8] = @gM8, [gM9] = @gM9, [gM10] = @gM10, [gM11] = @gM11, [gM12] = @gM12 WHERE [tbl_set_forecast_id] = @tbl_set_forecast_id">
                <SelectParameters>
        ...
        <div class="row" id="Div2" runat="server" visible="TRUE">
            <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceVSM" EnableTheming="True" KeyFieldName="tbl_set_forecast_id" Theme="Mulberry" Width="100%">
                <SettingsPager Visible="False" AlwaysShowPager="True" Mode="ShowAllRecords">
                </SettingsPager>
                <SettingsEditing EditFormColumnCount="5" Mode="Inline">
                </SettingsEditing>
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="DESC" FieldName="gDesc" VisibleIndex="2" ReadOnly="true">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="LAST GOAL" FieldName="gPreviousYear" VisibleIndex="3">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="JAN" FieldName="gM1" VisibleIndex="4">
            ...
            <asp:SqlDataSource ID="SqlDataSourceVSM" runat="server" ConnectionString="<%$ ConnectionStrings:DB_1033_DashboardConnectionString %>"
                SelectCommand="SELECT [tbl_set_forecast_id], [metric], [gDesc], [gPreviousYear], [gM1], [gM2], [gM3], [gM4], [gM5], [gM6], [gM7], [gM8], [gM9], [gM10], [gM11], [gM12], [gActualYear] FROM [tbl_set_forecast] where [metric] = @param1 and gType = 'VSM'"
                UpdateCommand="UPDATE [tbl_set_forecast] SET [gPreviousYear] = @gPreviousYear, [gActualYear] = @gActualYear, [gM1] = @gM1, [gM2] = @gM2, [gM3] = @gM3, [gM4] = @gM4, [gM5] = @gM5, [gM6] = @gM6, [gM7] = @gM7, [gM8] = @gM8, [gM9] = @gM9, [gM10] = @gM10, [gM11] = @gM11, [gM12] = @gM12 WHERE [tbl_set_forecast_id] = @tbl_set_forecast_id">
                <SelectParameters>
                    <asp:ControlParameter ControlID="ASPxRoundPanel1$ASPxComboBoxF1"
                        Name="param1" PropertyName="Value" Type="String" />
        ...
        <hr />
        <p>
            <asp:Label ID="Label3" runat="server" Text="AREA FORECAST"></asp:Label>
        </p>
        <div class="row" id="Div3" runat="server" visible="TRUE">
            <dx:ASPxGridView ID="ASPxGridView3" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceArea" EnableTheming="True" KeyFieldName="tbl_set_forecast_id" Theme="Mulberry" Width="100%">
                <SettingsPager Visible="False" AlwaysShowPager="True" Mode="ShowAllRecords">
                </SettingsPager>
                <SettingsEditing EditFormColumnCount="5" Mode="Inline">
                </SettingsEditing>
            ...
            <asp:SqlDataSource ID="SqlDataSourceArea" runat="server" ConnectionString="<%$ ConnectionStrings:DB_1033_DashboardConnectionString %>"
                SelectCommand="SELECT [tbl_set_forecast_id], [metric], [gDesc], [gPreviousYear], [gM1], [gM2], [gM3], [gM4], [gM5], [gM6], [gM7], [gM8], [gM9], [gM10], [gM11], [gM12], [gActualYear] FROM [tbl_set_forecast] where [metric] = @param1 and gType = 'AREA'"
                UpdateCommand="UPDATE [tbl_set_forecast] SET [gPreviousYear] = @gPreviousYear, [gActualYear] = @gActualYear, [gM1] = @gM1, [gM2] = @gM2, [gM3] = @gM3, [gM4] = @gM4, [gM5] = @gM5, [gM6] = @gM6, [gM7] = @gM7, [gM8] = @gM8, [gM9] = @gM9, [gM10] = @gM10, [gM11] = @gM11, [gM12] = @gM12 WHERE [tbl_set_forecast_id] = @tbl_set_forecast_id">
                <SelectParameters>
                    <asp:ControlParameter ControlID="ASPxRoundPanel1$ASPxComboBoxF1"
                        Name="param1" PropertyName="Value" Type="String" />
        ...
        <hr />
        <p>
            <asp:Label ID="Label4" runat="server" Text="CELL FORECAST"></asp:Label>
        </p>
        <div class="row" id="Div4" runat="server" visible="TRUE">
            <dx:ASPxGridView ID="ASPxGridView4" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceCell" EnableTheming="True" KeyFieldName="tbl_set_forecast_id" Theme="Mulberry" Width="100%">
                <SettingsPager Visible="False" AlwaysShowPager="True" Mode="ShowAllRecords">
                </SettingsPager>
                <SettingsEditing EditFormColumnCount="5" Mode="Inline">
                </SettingsEditing>
            ...
            <asp:SqlDataSource ID="SqlDataSourceCell" runat="server" ConnectionString="<%$ ConnectionStrings:DB_1033_DashboardConnectionString %>"
                SelectCommand="SELECT [tbl_set_forecast_id], [metric], [gDesc], [gPreviousYear], [gM1], [gM2], [gM3], [gM4], [gM5], [gM6], [gM7], [gM8], [gM9], [gM10], [gM11], [gM12], [gActualYear] FROM [tbl_set_forecast] where [metric] = @param1 and gType = 'CELL'"
                UpdateCommand="UPDATE [tbl_set_forecast] SET [gPreviousYear] = @gPreviousYear, [gActualYear] = @gActualYear, [gM1] = @gM1, [gM2] = @gM2, [gM3] = @gM3, [gM4] = @gM4, [gM5] = @gM5, [gM6] = @gM6, [gM7] = @gM7, [gM8] = @gM8, [gM9] = @gM9, [gM10] = @gM10, [gM11] = @gM11, [gM12] = @gM12 WHERE [tbl_set_forecast_id] = @tbl_set_forecast_id">
                <SelectParameters>
                    <asp:ControlParameter ControlID="ASPxRoundPanel1$ASPxComboBoxF1"
                        Name="param1" PropertyName="Value" Type="String" />
