<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_scrap.aspx.cs" Inherits="MxliDashboard.v_scrap" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_scrap" DisableHttpHandlerValidation="False">
