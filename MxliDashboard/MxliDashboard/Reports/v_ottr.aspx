<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_ottr.aspx.cs" Inherits="MxliDashboard.v_ottr" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_ottr" DisableHttpHandlerValidation="False">
