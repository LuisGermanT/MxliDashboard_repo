<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_kaizens.aspx.cs" Inherits="MxliDashboard.v_kaizens" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_kaizens" DisableHttpHandlerValidation="False">
