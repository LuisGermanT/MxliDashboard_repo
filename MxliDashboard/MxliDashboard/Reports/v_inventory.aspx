<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_inventory.aspx.cs" Inherits="MxliDashboard.v_inventory" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_inventory" DisableHttpHandlerValidation="False">
