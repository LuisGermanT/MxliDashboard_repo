<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_entitlement.aspx.cs" Inherits="MxliDashboard.v_entitlement" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_entitlement" DisableHttpHandlerValidation="False">
