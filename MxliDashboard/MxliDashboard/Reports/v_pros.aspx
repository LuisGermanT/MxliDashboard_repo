<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_pros.aspx.cs" Inherits="MxliDashboard.v_pros" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_pros" DisableHttpHandlerValidation="False">
