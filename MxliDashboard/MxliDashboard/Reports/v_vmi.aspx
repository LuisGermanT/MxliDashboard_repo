<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_vmi.aspx.cs" Inherits="MxliDashboard.v_vmi" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_vmi" DisableHttpHandlerValidation="False">
