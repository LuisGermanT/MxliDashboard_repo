<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_productivity.aspx.cs" Inherits="MxliDashboard.v_productivity" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_productivity" DisableHttpHandlerValidation="False">
