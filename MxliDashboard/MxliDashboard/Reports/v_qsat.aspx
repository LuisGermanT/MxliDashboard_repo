<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_qsat.aspx.cs" Inherits="MxliDashboard.v_qsat" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_qsat" DisableHttpHandlerValidation="False">
