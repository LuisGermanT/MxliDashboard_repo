<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_cars.aspx.cs" Inherits="MxliDashboard.v_cars" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_cars" DisableHttpHandlerValidation="False">
