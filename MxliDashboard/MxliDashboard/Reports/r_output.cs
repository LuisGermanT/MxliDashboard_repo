...
/// </summary>
public class r_output : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private void InitializeComponent()
    {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(r_output));
        ...
        series2};
            ...
            customSqlQuery2.Sql = "select top 6 smaterial, sum(fTstdhrs) as cValue, \r\nsum(sum(fTstdhrs)) over (order" +
    " by sum(fTstdhrs) desc) as Acum\r\nFROM[DB_1033_Dashboard].[dbo].[tbl_output]\r\ngro" +
    ...
    "board].[dbo].[sta_nivel2f]\r\n where smetric = \'output\'\r\nand stype = \'monthly\' ord" +
    "er by id desc)\r\nq1 order by id ";
