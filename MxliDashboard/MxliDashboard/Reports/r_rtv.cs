...
/// </summary>
public class r_rtv : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private void InitializeComponent()
    {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(r_rtv));
        ...
        series2};
            ...
            customSqlQuery2.Sql = "SELECT top 5 smaterial, SUM(total)as cValue, \r\nsum(sum(total)) over (order by sum" +
    "(total) desc)as Acum\r\nFROM[DB_1033_Dashboard].[dbo].[sap_rtv]\r\ngroup by smateria" +
    "l order by cValue desc\r\n";
            customSqlQuery3.Name = "Query_3";
            customSqlQuery3.Sql = "select top 5 * from [tbl_actions]\r\nwhere report = \'rtv\'";
            customSqlQuery4.Name = "Query_4";
            customSqlQuery4.Sql = "SELECT * FROM\r\n(SELECT top 3 [id],factual,\r\nfsum,[scause] \r\n FROM [DB_1033_Dashbo" +
