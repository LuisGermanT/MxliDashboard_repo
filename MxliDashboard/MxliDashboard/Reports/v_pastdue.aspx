<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_pastdue.aspx.cs" Inherits="MxliDashboard.v_pastdue" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_pastdue" DisableHttpHandlerValidation="False">
