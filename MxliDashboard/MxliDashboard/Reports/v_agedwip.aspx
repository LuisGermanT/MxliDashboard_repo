<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_agedwip.aspx.cs" Inherits="MxliDashboard.v_agedwip" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_agedwip" DisableHttpHandlerValidation="False">
