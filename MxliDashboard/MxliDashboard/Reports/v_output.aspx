<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_output.aspx.cs" Inherits="MxliDashboard.v_output" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_output" DisableHttpHandlerValidation="False">
