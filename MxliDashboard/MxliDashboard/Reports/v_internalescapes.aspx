<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_internalescapes.aspx.cs" Inherits="MxliDashboard.v_internalescapes" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1" runat="server" ColorScheme="softblue" ReportSourceId="r_internalescapes" DisableHttpHandlerValidation="False">
