...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent1" runat="server">
                <table style="table-layout: fixed">
                    <tr>
                        <th>
                            <dx:ASPxLabel ID="ASPxLabelCaption1" runat="server" Text="Select Supplier:">
                            </dx:ASPxLabel>
                            <dx:ASPxComboBox ID="ASPxComboBoxSupInContent" runat="server" ValueField="ssupplier"
                                TextField="ssupplier" ValueType="System.String" DataSourceID="SqlDataSourceSup"
                                AutoPostBack="True" OnDataBound="cmbox_DataBoundSup">
    ...
    <asp:SqlDataSource ID="ds_inventory" runat="server" ConnectionString="Data Source=MX29W1009;Initial Catalog=DB_1033_Dashboard;Persist Security Info=True;User ID=OPEX_Users;Password=Gqb%Pjo7XZ"
        SelectCommand="SELECT [smaterial], [sdescription], [ssupplier], [price], [totqty], [Total] FROM [tbl_vmi] where ssupplier like @pSup">
        <SelectParameters>
            <asp:ControlParameter ControlID="ASPxRoundPanel1$ASPxComboBoxSupInContent"
                Name="pSup" PropertyName="Value" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSourceSup" runat="server" ConnectionString="Data Source=MX29W1009;Initial Catalog=DB_1033_Dashboard;Persist Security Info=True;User ID=OPEX_Users;Password=Gqb%Pjo7XZ"
        SelectCommand="SELECT distinct [ssupplier] FROM [tbl_vmi] order by ssupplier"></asp:SqlDataSource>
    <p />
    <hr />
    <p />
        ...
        <PanelCollection>
            <dx:PanelContent ID="PanelContent4" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSourceActions" runat="server" ConnectionString="<%$ ConnectionStrings:DB_1033_DashboardConnectionString %>" 
                    SelectCommand="SELECT [tbl_actions_id], [area], [vsm], [mrp], [report], [material], [issue], [action], [responsible], [open_close], [creation_date], [creation_user], [due_date] FROM [tbl_actions] WHERE [REPORT] = 'VMI'"></asp:SqlDataSource>
            </dx:PanelContent>
        </PanelCollection>
    </dx:ASPxRoundPanel>
</asp:Content>
